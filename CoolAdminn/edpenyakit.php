    ...
    <table width="509" border="0" align="center">
      ...
      <tr>
        <td height="39" colspan="3" valign="top">
          <div align="center">
            <div align="center"><span class="style38"><strong> Edit penyakit </strong></span></div>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td valign="top"><input type="submit" name="simpan" id="simpan" value="Update" />
          <a href="http://localhost/CoolAdmin/chart.php"><input type="button" name="batal" id="batal" value="Batal" /></a></td>
        </a></td>
      </tr>
      <tr>
