                                ...
                                <table id="table" class="table">
                                    <thead class="thead-dark">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">Penyakit Yang di derita</th>
                                    ...
                                    include "koneksi.php";
                                    $sql = "SELECT hasil.id, hasil.nama, hasil.kelamin, hasil.umur, hasil.alamat, hasil.kd_penyakit, hasil.tanggal, penyakit.kd_penyakit, penyakit.nama_penyakit FROM hasil, penyakit WHERE hasil.kd_penyakit=penyakit.kd_penyakit AND hasil.tanggal";
                                    ...
                                    ?>
                                        <tbody>
                                            <tr valign="baseline">
                                                ...
                                                <td><a title="Hapus Pengguna" style="cursor:pointer;" onClick="return konfirmasi('<?php echo $data['id']; ?>')"><i class="fas fa-trash"></i> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php
                                    } ?>
